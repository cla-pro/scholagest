...
public class StudentManager extends ObjectManager implements IStudentManager {
    ...
    public String createStudent(String requestId, ITransaction transaction) throws Exception {
        ...
        String personalInfoKey = super.createObject(requestId, transaction, generatePersonalInfoKey(studentBase), CoreNamespace.tStudentPersonalInfo);
        String medicalInfoKey = super.createObject(requestId, transaction, generateMedicalInfoKey(studentBase), CoreNamespace.tStudentMedicalInfo);
