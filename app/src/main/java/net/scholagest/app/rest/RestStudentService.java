...
public class RestStudentService {
	...
	public String getStudents(
		...
		try {
			Map<String, Map<String, Object>> teachersInfo =
					studentService.getStudentsWithProperties(requestId, properties);
	...
	public String getStudentInfo(
			@QueryParam("token") String token,
			@QueryParam("studentKey") String studentKey,
			@QueryParam("properties") List<String> properties) {
		String requestId = REQUEST_ID_PREFIX + UUID.randomUUID();
		try {
			Map<String, Object> info = new HashMap<String, Object>();
			info.put(ScholagestNamespace.pStudentPersonalInfo, this.studentService.getStudentPersonalInfo(
					requestId, studentKey, new HashSet<String>(properties)));
			info.put(ScholagestNamespace.pStudentMedicalInfo, this.studentService.getStudentMedicalInfo(
					requestId, studentKey, new HashSet<String>(properties)));
	...
	private Map<String, Map<String, Object>> extractOntology(Map<String, Object> info) throws Exception {
		...
		for (Map.Entry<String, Object> entry : info.entrySet()) {
			...
			OntologyElement element = ontologyService.
