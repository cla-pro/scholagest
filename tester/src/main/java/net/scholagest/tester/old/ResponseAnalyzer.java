...
public class ResponseAnalyzer {
    ...
    // }
    //
    // public void analyzeContentExchange(TCall call, ContentExchange
    // contentExchange) throws UnsupportedEncodingException {
    ...
    // }
    //
    // private CallResultStatus getTestResultStatus(List<FieldResult>
    // fieldResultList) {
    ...
    // }
    //
    // private List<FieldResult> checkContent(TCall call, ContentExchange
    // contentExchange) throws UnsupportedEncodingException {
    ...
    // }
    //
    // private void checkAndStoreResult(List<FieldResult> fieldResultList,
    // TResult result, String resultValue) {
    ...
    // }
    //
    // private boolean isReceivedResultCorrect(TResult result, String
    // resultValue) {
    ...
    // }
    //
    // private boolean isResultExpectedButNotReceived(TResult result, String
    // resultValue) {
    ...
    //
    // StringMap<Object> converted = new Gson().fromJson(response,
    // StringMap.class);
    // return getValueRec(pathElements, 0, converted);
    // }
    //
    // @SuppressWarnings("unchecked")
    // private String getValueRec(String[] pathElements, int i,
    // StringMap<Object> subJson) {
